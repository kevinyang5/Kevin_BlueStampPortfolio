...
I used a 16x2 LCD Screen to display the elapsed time of any time trial using my project. The specific LCD display I used has an I2C module connected to it, which allows it to communicate using I2C protocol. 
